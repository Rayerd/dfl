...
set dfl_libs=%dmc_path%\lib\gdi32.lib %dmc_path%\lib\comctl32.lib %dmc_path%\lib\advapi32.lib %dmc_path%\lib\comdlg32.lib %dmc_path%\lib\ole32.lib %dmc_path%\lib\uuid.lib %dmd_path%\lib\ws2_32.lib %dfl_libs_dfl%
...
%dmd_path%\bin\dmd %_dfl_flags% -c -o- -Dddoc %dfl_files%
...
@rem   @del *.di
@rem   %dmd_path%\bin\dmd -H -o- -c -I.. %_dfl_flags% %dfl_files%
@rem   @if errorlevel 1 goto oops
